...
3. Set the variable `Test` to `False` in the `main` function to run all the 260 chapters/paragraphs of the Bible collection ENGKJV. You can eventually run a test on single chapters (line 622 and 623) by choosing a key number between 1-260 and set the variable to `True`.
